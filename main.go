...
import (
	...
	"github.com/chaimch/akita-inu/cmd"
	_ "github.com/chaimch/akita-inu/logger"
...
func main() {
	...
	app.Commands = []cli.Command{
		...
		{
			Name:  "golang",
			Usage: "akita-inu init new-golang-project with go.",
			Subcommands: []cli.Command{
				{
					Name:      "init",
					UsageText: "golang init web github.com/chaimch/prj",
					Subcommands: []cli.Command{
						{
							Name: "web",
		...
		{
			Name:  "migrations",
			Usage: "akita-inu init golang migrations with go.",
			Subcommands: []cli.Command{
				{
					Name: "init",
					Action: func(c *cli.Context) error {
